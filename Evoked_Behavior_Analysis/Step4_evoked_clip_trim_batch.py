...
def main():
    ...
    while True:
        try:
            ...
            project_type_input = input("Are you working on Trigeminal Neuralgia project (1) or TMJ project (2) (enter 1 or 2): ").strip()
            project_type = int(project_type_input.strip())
            
            # FACIAL PAIN PROJECT
            # Project paths, edit if on new machine or directory structure!!!
            if project_type == 1:
                ...
                METADATA_PATH = r"I:\Projects\orofacial_project\data\evoked\raw_files\experiment_metadata.csv"
               

            # TMJ PROJECT
            # Project paths, edit if on new machine or directory structure!!!
            if project_type == 2:
                INPUT_BASE_DIR = r"I:\Projects\tmj_project\data\evoked\raw_files"
                OUTPUT_BASE_DIR = r"I:\Projects\tmj_project\data\evoked\processed_files"
                METADATA_PATH = r"I:\Projects\tmj_project\data\evoked\raw_files\experiment_metadata.csv"

            print(f"**Input Base:** {INPUT_BASE_DIR}")
            print(f"**Output Base:** {OUTPUT_BASE_DIR}")
            print(f"**Global Metadata:** {METADATA_PATH}")
